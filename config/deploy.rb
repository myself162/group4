...
role :web, "group4.com"                          # Your HTTP server, Apache/etc
role :app, "group4.com"                         # This may be the same as your `Web` server
role :db,  "group4.com"   , :primary => true # This is where Rails migrations will run
